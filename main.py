...
# --- Configuration ---
# ⚠️ ACTION REQUIRED: Set DISCORD_BOT_TOKEN in your Railway environment variables
BOT_TOKEN = os.environ.get("DISCORD_BOT_TOKEN")  
# Optional: Set GUILD_ID to a guild ID for immediate slash command testing
...
async def embed_command(
    ...
    try:
        ...
        try:
            # Check if interaction has been responded to, if not, respond.
            ...
            # if both response and followup fail, just log to console
            print(err_text)
